...
@Component({
  selector: 'ngx-modal-imputation-heure',
  templateUrl: './modal-imputation-heure.component.html',
  styleUrls: ['./modal-imputation-heure.component.scss']
})
export class ModalImputationHeureComponent implements OnInit {
 ...
 mois = ["01","02","03","04","05","06","07","08","09","10","11","12"]
  ...
  constructor(private toastrService: NbToastrService,
    public router: Router, public  imputationservice : ImputationService, public employeService: EmployeListService, public contratService: ContratService, public windowRef: NbWindowRef ) { }
  ...
  ngOnInit() {
    ...
    this.employeService.getAllEmployesParHeure(+idEntreprise).subscribe(
      data => {
        this.employes = data;
      },
      error=>{
