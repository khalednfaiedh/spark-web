...
@Component({
  selector: 'ngx-show-numerique-bon-de-livraison',
  templateUrl: './show-numerique-bon-de-livraison.component.html',
  styleUrls: ['./show-numerique-bon-de-livraison.component.scss']
})
export class ShowNumeriqueBonDeLivraisonComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.serviceBonLivraison.getBondeLivraisonById(+idBL).subscribe(dataBL => {
      ...
      this.servicefacture.getFactureById(this.bonLivraison.code_fac).subscribe(dataFacture => {
